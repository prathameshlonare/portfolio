      ...
      >
        ...
        <div className="hidden md:flex items-start justify-between gap-2">
          ...
          <div className="flex items-center gap-3 shrink-0">
            <span className="text-[var(--accent-green)] text-sm font-mono">
              [{year}]
            </span>
            {githubUrl && (
              <a
                ...
                onClick={(e) => { e.stopPropagation(); trackProjectClick(name, githubUrl); }}
              >
                Github
        ...
        <div className="md:hidden">
          <div className="flex items-center justify-between gap-2">
            <span className="text-[var(--accent-blue)] font-medium text-sm truncate min-w-0">
              <ScrambleText text={name} />
            </span>
            <div className="flex items-center gap-2 shrink-0">
              ...
              {githubUrl && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1 text-xs text-[var(--accent-green)] border border-[var(--accent-green)]/30 rounded px-1.5 py-0.5 hover:bg-[var(--accent-green)]/10 transition-colors"
                  style={{ touchAction: "manipulation" }}
                onClick={(e) => { e.stopPropagation(); trackProjectClick(name, githubUrl); }}
                >
                  GH
