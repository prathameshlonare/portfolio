  ...
  return (
    <div id={id} className="w-full max-w-7xl mx-auto my-6 border-3 border-[#1A1A2E] bg-white shadow-[6px_6px_0px_#1A1A2E]">
      ...
      <button
        ...
        className="w-full p-4 md:p-6 flex justify-between items-center bg-[#FAFAFA] border-b-2 border-[#1A1A2E] text-left hover:bg-white transition-all hover:-translate-x-0.5 hover:-translate-y-0.5"
      >
