      ...
      <main id="main-content" className="flex-1 max-w-7xl mx-auto px-4 md:px-8 py-8 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start my-8">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            <div className="border-3 border-[#1A1A2E] bg-white shadow-[6px_6px_0px_#1A1A2E] p-6">
              <MonoLabel className="text-[#FF6B35] mb-2 block">DIRECT EMAIL</MonoLabel>
              <div className="flex items-center justify-between border-2 border-[#1A1A2E] bg-[#FAFAFA] p-4">
                <div className="flex items-center gap-3">
                  <Mail className="w-5 h-5 text-[#FF6B35]" />
                  <span className="font-mono text-sm font-extrabold text-[#1A1A2E]">
                    {EMAIL}
                  </span>
                </div>
                <button
                  onClick={handleCopyEmail}
                  className="neo-btn py-1 px-3 text-xs font-mono"
            ...
            <div className="border-3 border-[#1A1A2E] bg-white shadow-[6px_6px_0px_#7C3AED] p-6 flex flex-col gap-4">
